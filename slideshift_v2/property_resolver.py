"""
SlideShift v2 — PropertyResolver

The 7-level OOXML property inheritance resolver. This is the most important
class in the SlideShift v2 system: it walks the full Open XML inheritance
...
class PropertyResolver:
    ...
    This class is the foundation of SlideShift v2's Phase 0. It accepts a
