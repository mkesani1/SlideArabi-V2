...
from slideshift_v2.structural_validator import StructuralValidator, IssueType
...
class TestStructuralValidator(unittest.TestCase):
    ...
    def test_rtl_direction_check(self):
        ...
        mock_paragraph._pPr.get.return_value = None
    ...
    def test_overlap_check(self):
        ...
        s1.left, s1.top, s1.width, s1.height = 100, 100, 100, 100
        ...
        s2.left, s2.top, s2.width, s2.height = 150, 150, 100, 100
